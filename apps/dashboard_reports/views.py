...
from apps.dashboard_reports.models import JobData, JobStatusChoices, JobHostSummary, SubscriptionCost
...
class DashboardReportViewSet(ReadOnlyModelViewSet):
    ...
    def get_queryset(self) -> QuerySet[JobData]:
        ...
        average_cost_employee_minute = subscription_cost.engineer_avg_hourly_rate / decimal.Decimal(60)
        monthly_aap_subscription_cost = subscription_cost.monthly_subscription_cost
